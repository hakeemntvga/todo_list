...
import 'package:to_do_app/app/modules/home/widgets/add-dialog.dart';
        ...
        builder: (_, __, ___) {
          return Obx(
            () => FloatingActionButton(
              backgroundColor:
                  controller.deleting.value ? Color.fromARGB(255, 188, 45, 35) : Color.fromARGB(198, 19, 48, 190),
              onPressed: () {
                if (controller.tasks.isNotEmpty) {
                  Get.to(() => AddDialog(), transition: Transition.downToUp);
                } else {
                  EasyLoading.showInfo("Plaese create your task type");
                }
              },
